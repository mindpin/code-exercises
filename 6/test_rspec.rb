...
RSpec.describe "test 6" do
  ...
  it "expect(run(str)).to eq(res)" do
    ...
    res = [
      {:name => "e", :count => 4, :index => [0, 3, 20, 24]},
      {:name => "x", :count => 1, :index => [1]},
      {:name => "p", :count => 1, :index => [2]},
      {:name => "c", :count => 1, :index => [4]},
      {:name => "t", :count => 3, :index => [5, 12, 17]},
      {:name => "(", :count => 3, :index => [6, 10, 22]},
      {:name => "r", :count => 3, :index => [7, 13, 23]},
      {:name => "u", :count => 1, :index => [8]},
      {:name => "n", :count => 1, :index => [9]},
      {:name => "s", :count => 2, :index => [11, 25]},
      {:name => ")", :count => 3, :index => [14, 15, 26]},
